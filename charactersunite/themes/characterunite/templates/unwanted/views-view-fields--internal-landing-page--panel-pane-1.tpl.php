...
?>
    ...
    <?php if ((isset($row->field_field_ds_title_1) || isset($row->field_field_ds_title_2) || isset($row->field_field_ds_body) || 
      isset($row->field_field_ds_link)) && strtolower($row->field_field_ds_position[0]['raw']['value']) != 'right'): ?>
